...
solver.net.params['conv2'][0].data[:,:] = np.load('./weights/conv2.npy')
solver.net.params['conv3'][0].data[:,:] = np.load('./weights/conv3.npy')
solver.net.params['conv4'][0].data[:,:] = np.load('./weights/conv4.npy')
solver.net.params['conv5'][0].data[:,:] = np.load('./weights/conv5.npy')
solver.net.params['conv1'][1].data[:] = np.load('./weights/conv1_b.npy')
solver.net.params['conv2'][1].data[:] = np.load('./weights/conv2_b.npy')
